...
// actions
import { selectPerLogToEdit } from "../../../../redux/app/app.selectors"
import { makeACheck } from "../../../../redux/character-sheet/pages/pages.actions"

class NewPersonalLog extends React.Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    if (this.props.perLogToEdit) {
      const {
        perLogToEdit: { id, title, date, details },
      } = this.props
      this.setState({
        id: id,
        title: title,
    ...
    return (
      <>
        ...
        <form className="popupform__form purple-top-border" onSubmit={(e) => this.handleSubmit(e)}>
          ...
          <ButtonPanel submitValue={`Save Personal Log`} />
        </form>
      </>
    )
  }
...
const mapStateToProps = createStructuredSelector({
  perLogToEdit: selectPerLogToEdit,
})
...
export default connect(mapStateToProps, mapDispatchToProps)(NewPersonalLog)
