...
class LevelInfo extends React.Component {
  ...
  render() {
    ...
    speedAbility = Math.ceil(parseInt(refTotal) * 0.1);
    ...
    speedTotalH =
      parseInt(speedAbility) +
      parseInt(equipmentSpeed) +
      parseInt(speedTemp) +
      parseInt(speedMisc);
    perceptionTotalH =
      parseInt(perceptionAbility) +
      parseInt(equipmentPerception) +
      parseInt(perceptionTemp) +
      parseInt(perceptionMisc);
    reactionTotalH =
      parseInt(reactionAbility) +
      parseInt(equipmentReflex) +
      parseInt(reactionTemp) +
      parseInt(reactionMisc);
    fortitudeTotalH =
      parseInt(fortitudeAbility) +
      parseInt(equipmentPhysique) +
      parseInt(fortitudeTemp) +
      parseInt(fortitudeMisc);
    stealthTotalH =
      parseInt(stealthAbility) +
      parseInt(equipmentStealth) +
      parseInt(stealthTemp) +
      parseInt(stealthMisc);
        ...
        <div className="weapon-div">
          ...
          <table>
            ...
            <tr>
              <td>Stealth</td>
              <td>
                <span>{stealthTotalH}</span>
              </td>
              <td>
                <span>{stealthAbility}</span>
              </td>
              <td>
