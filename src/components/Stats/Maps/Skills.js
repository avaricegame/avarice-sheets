...
class Skills extends React.Component {
  ...
  render() {
    ...
    let acrobatics = calculateTotal(
      "acrobatics",
      acrobaticsMisc,
      acrobaticsAbility,
      acrobaticsRanks
    );
    let accuracy = calculateTotal(
      "accuracy",
      accuracyMisc,
      accuracyAbility,
      accuracyRanks
        ...
        <div className="weapon-div">
          ...
          <table>
            ...
            <tr>
              ...
              <td>CHA</td>
              <td>{useMagicDevice}</td>
              <td>{useMagicDeviceAbility}</td>
              <td>
                <input
