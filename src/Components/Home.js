...
const Home = ({ onRouteChange, characterSheet }) => {
  return (
    <div className="container">
      <header>
        <div>
          <h2 className="heading-link" onClick={() => onRouteChange("signedout")}>
            Sign Out
          </h2>
        </div>
        <div>
      ...
      <div class="character-sheets">
        <div className="character-sheets-heading-div">
          ...
          <button id="createNewCharacterSheetButton" className="header-button">
        ...
        <form id="createNewCharacterSheetForm">
          <fieldset>
            ...
            <p>
              Want to learn more about the Races and Classes of Pax?{" "}
              <a href="" target="_blank">
                Visit our site to learn everything you will need to know,
              </a>{" "}
              and read about our{" "}
              <a href="" target="_blank">
                races
          ...
          <fieldset>
            <legend>Information for Starting Out</legend>
