...
class CustomArmourForm extends React.Component {
  ...
  onSubmit = (e) => {
    e.preventDefault()
    const { name, bodyArea, requirements, hp, speed, strength, dexterityReflex, constitutionFortitude, intelligence, charisma, perception, stealth, rangedAccuracy, meleeAccuracy, magicalAbilities, description, createdBy, published, imageurl } = this.state
