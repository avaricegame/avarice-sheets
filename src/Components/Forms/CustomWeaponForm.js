...
class CustomWeaponForm extends React.Component {
  ...
  onSubmit = (e) => {
    console.log(e.target.value)
    e.preventDefault()
    const { weaponName, rangedMelee, imageurl, range, proficiency, weaponType, requirements, abilityBonus, damage, uses, critical, magicalAbilities, description, published, createdBy } = this.state

    this.props.addWeapon(weaponName, rangedMelee, imageurl, range, proficiency, weaponType, requirements, abilityBonus, damage, uses, critical, magicalAbilities, description, published, createdBy)
    this.setState({
      weaponName: "",
      rangedMelee: "",
      imageurl: "",
