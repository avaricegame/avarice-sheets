    ...
    <>
      ...
      <div className="page-container">
        <div className="cs__100">
          <h2 className="heading">About Your Avarice Campaign Sheet</h2>
          <div className="cw__container">
            <h3 className="item-container__subheading item-container__subheading--lighter">What is an Avarice Campaign Sheet?</h3>
