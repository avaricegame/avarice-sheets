  ...
  return (
    <>
      <div className="secondary-header">
        <h1 className="secondary-header__heading">About</h1>
      </div>
      <div className="page-container">
        <div className="cs__100">
          <h2 className="heading">About Your Avarice Character Sheet</h2>
          <div className="cw__container">
            <h3 className="item-container__subheading item-container__subheading--lighter">What is an Avarice Character Sheet?</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            <h3 className="item-container__subheading item-container__subheading--lighter">How do I get started?</h3>
            ...
            <h3 className="item-container__subheading item-container__subheading--lighter">What are all of these buttons and how do I know what to press?</h3>
            ...
            <h3 className="item-container__subheading item-container__subheading--lighter">Lorem ipsum dolor sit amet?</h3>
            ...
            <h3 className="item-container__subheading item-container__subheading--lighter">Duis aute irure dolor in reprehenderit?</h3>
