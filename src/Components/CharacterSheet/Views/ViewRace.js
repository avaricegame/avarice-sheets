...
function ViewRace(props) {
  return (
    <div className="item-container">
      <h3 className="item-container__heading">Race Details and Information</h3>
      <h4 className="item-container__subheading">Race Name: {props.data.name}</h4>
      ...
      <table>
        <tbody>
          ...
          <tr>
            <td>Lifespan:</td>
            <td>{props.data.lifespan}</td>
          </tr>
          <tr>
            <td>Personality:</td>
            <td>{props.data.personality}</td>
          </tr>
          <tr>
            <td>Friends:</td>
            <td>{props.data.friends}</td>
          </tr>
          <tr>
            <td>Enemies:</td>
            <td>{props.data.enemies}</td>
          </tr>
        </tbody>
      </table>
      <p>Specializations:</p>
