    ...
    return (
      <React.Fragment>
        <div className="weapon-div">
          ...
          <EditLevelForm setLevel={setLevel} editExcellenceChips={editExcellenceChips} />
          <p style={{ paddingBottom: "20px" }}>
            You currently have <strong>4</strong> Rank Points and <strong>2 </strong>
            Ability Scores Level Up points that you can use. Be sure to apply them to keep your character as buff and smart as possible!
          </p>
        </div>
        <div className="weapon-div">
